...
def get_gemini_response(message):
    try:
        ...
        # Check for exact matches in custom responses first
...
def otp_verification(request):
    ...
    if request.method == 'POST':
        ...
        if otp and otp.is_valid():
            ...
            return render(request, 'chat/otp_verification.html', {
                'username': username,
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            send_mail(
                ...
                f'Your OTP code for password reset is: {otp.code}. It will expire in 10 minutes.',
                settings.DEFAULT_FROM_EMAIL,
                [email],
                fail_silently=False,
            )
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if otp.is_valid():
                ...
                return render(request, 'chat/reset_password_otp.html', {
                    'email': email,
                    'error': 'Invalid or expired OTP'
                })
